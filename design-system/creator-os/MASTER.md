...
> **Authority override:** This generated file is a supplemental UX checklist only. The user-selected TraeWork Light library and the root `DESIGN.md` are the authoritative visual system for Creator OS. Do not apply this file's pink palette, hero pattern, marketing layout, shadows, or modal guidance to product UI.
